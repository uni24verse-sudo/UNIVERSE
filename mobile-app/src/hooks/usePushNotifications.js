...
// Set how notifications are handled when the app is in the foreground (native only)
if (Platform.OS !== 'web') {
...
async function registerForPushNotificationsAsync() {
  ...
  if (Device.isDevice) {
    try {
      ...
      console.warn('Push notification token fetch skipped (expected in standard Expo Go client):', err.message);
    }
  } else {
