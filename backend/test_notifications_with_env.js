...
async function testNotifications() {
  console.log('🧪 Testing OneSignal Notifications with Environment...\n');
  
  try {
    // Test 1: New Order Notification (Cash Order)
    console.log('1. Testing New Order Notification (Cash)...');
...
testNotifications().then(() => {
  ...
  console.log('- Test vendor ID used:', testVendorId);
  process.exit(0);
}).catch(err => {
