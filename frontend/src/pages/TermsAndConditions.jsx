      ...
      <div style={{
        ...
        <div style={{
          ...
          <section style={{ marginBottom: '2.5rem' }}>
            ...
            <p style={{ marginBottom: '1.5rem' }}>
              This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name <span style={{ color: 'var(--primary)' }}>https://food.universeorder.co.in</span> ('Website', including alias universeorder.co.in and uat.food.universeorder.co.in), including the related mobile site and mobile application (hereinafter referred to as 'Platform').
            </p>
            <p>
          ...
          <div style={{ 
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem', fontSize: '0.95rem' }}>
              ...
              <p><strong style={{ color: 'var(--text-primary)' }}>Website:</strong> <span style={{ color: 'var(--primary)', fontWeight: '700' }}>https://food.universeorder.co.in</span></p>
            </div>
          </div>
        </div>
      </div>
